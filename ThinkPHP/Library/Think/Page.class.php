...
class Page{
    ...
    public function show() {
        ...
        for($i = 1; $i <= $this->rollPage; $i++){
            ...
            if($page > 0 && $page != $this->nowPage){
                ...
                if($page <= $this->totalPages){
                    ...
                    if($this->yctx){
                        $link_page .= '<li class="paginate_button previous" ><a class="num" href="' . $this->url($page) . '">' . $page . '</a></li>';
                    }else{
                ...
                if($page > 0 && $this->totalPages != 1){
                    if($this->yctx){
                        $link_page .= '<li class="paginate_button previous"><span class="current">' . $page . '</span></li>';
                    }else{
        ...
        if($this->yctx){
            ...
            return "<ul class=\"pagination pagination-sm no-margin pull-right\">{$page_str}</ul>";
        }
    }
    public function setYctx($val){
        $this->yctx = $val;
    }
}
